...
<center>
<button class="btn btn-success guardar" id="guardar-liquidacion"><b>Generar</b></button></center>
    ...
    if (tramitesSeleccionados[0].tramiteId == tramiteId) {
      ...
      // Realiza la acción que necesitas cuando el primer registro coincide con tramiteId
       ...
       sistematizacion = 0; 
          ...
          console.log(sistematizacion);
          
        
    $.ajax({
      url: 'obtener_conceptos.php',
      method: 'GET',
      data: { tramiteId: tramiteId, claseVehiculo:claseVehiculo,sistematizacion: sistematizacion,placa:placa,tipoVehiculo:tipoVehiculo},
      success: function(response) {
...
$('#guardar-liquidacion').click(function() {
 ...
 // Verificar si tramitesSeleccionados está vacío
  ...
  $.ajax({
    ...
    window.open('https://transitar2.online/imprimir_liquidacion.php?id=' + response, '_blank');
    location.href = 'https://transitar2.online/liquidaciones.php';
    },
    error: function() {
