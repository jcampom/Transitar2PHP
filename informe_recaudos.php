 ...
 <div class="col-md-6">
    ...
    <label>Medio de pago:</label>
            <select name="medio_pago"   class="form-control" id='medio_pago' onchange="TipoDeuda(this)">
              <option value="">Seleccione...</option>
              <option value="1" <?php if($_POST['medio_pago']==1){echo "selected='selected'";}?>>Taquilla</option>
              <option value="4" <?php if($_POST['medio_pago']==4){echo "selected='selected'";}?>>Archivo Plano</option>
              <option value="6" <?php if($_POST['medio_pago']==6){echo "selected='selected'";}?>>Embargo</option>
