...
<div class="col-md-6">
    ...
    <label>Tipo deuda:</label>
            <select name="tipodeuda" required onchange="this.form.submit()" class="form-control" id='tipodeuda' onchange="TipoDeuda(this)">
              ...
              <option value="4" <?php if($_POST['tipodeuda']==4){echo "selected='selected'";}?>>Comparendos</option>
              <option value="6" <?php if($_POST['tipodeuda']==6){echo "selected='selected'";}?>>Acuerdos de pago</option>
              <option value="7" <?php if($_POST['tipodeuda']==7){echo "selected='selected'";}?>>Derechos transito</option>
            </select>
                      </div>
                 </div>
 </div> 
