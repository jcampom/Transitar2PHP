...
$result_liquidacion = $mysqli->query($sql_liquidacion);
$row_liquidacion = $result_liquidacion->fetch_assoc();
...
$result_recaudo = $mysqli->query($sql_recaudo);
$row_recaudo = $result_recaudo->fetch_assoc();
                ?>
                <div id="datos" >
                <!-- Columna 2 -->
                <div class="row">
