...
for ($i = $_POST['inicio']; $i <= $_POST['fin']; $i++) {
 ...
 $insert_detalle = "UPDATE especies_venales_detalle SET agente = '".$_POST['agente']."', fecha_entrega = '$fechayhora'  where id = '$i' and tipo = '5' ";
    ...
    sqlsrv_query( $mysqli,$insert_detalle, array(), array('Scrollable' => 'buffered'));
       ...
       echo '<div class="alert alert-success"><strong>¡Bien hecho!</strong> Los comparendos se han actualizado correctamente.</div>';
}
    
?>
<div class="card container-fluid">
    <div class="header">
        <h2>Entrega Especie venal
Comparendos</h2>
    </div>
    <br>
