...
if (isset($_GET['generar'])) {
    ...
    $query = "SELECT TOP 1000 Tcomparendos_comparendo AS comparendo, CAST(Tcomparendos_fecha AS DATE) AS fechacomp, 
            ...
            ORDER BY fechahora DESC"; // Emula TOP 1000 en MySQL
// echo $query;
