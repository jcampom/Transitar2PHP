<?php include 'menu.php';
   ...
   $consultac="SELECT * FROM menu_items where id = '".$_GET['id']."'";

                  $resultadoconsultac=sqlsrv_query( $mysqli,$consultac, array(), array('Scrollable' => 'buffered'));

                  $rowconsultac=sqlsrv_fetch_array($resultadoconsultac, SQLSRV_FETCH_ASSOC);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" name="nombre" value="<?php echo $rowconsultac['nombre'] ?>" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    
                           <input type="hidden" name="editar" value="<?php echo $rowconsultac['id'] ?>" >
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label for="enlace">Enlace:</label>
                                <input type="text" name="enlace" value="<?php echo $rowconsultac['enlace'] ?>" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <select name="padre" class="form-control">
                                      <option value="<?php echo $rowconsultac['padre_id'] ?>"><?php echo $rowconsultac['padre_id'] ?></option>
  ...
  <select class="form-control" name="icono"  data-live-search="true">
     <option  value="<?php echo $rowconsultac['icono'] ?>" data-content="<i class='material-icons' style='margin-left: 15px;'><?php echo $rowconsultac['icono'] ?></i> <?php echo $rowconsultac['icono'] ?>"><?php echo $rowconsultac['icono'] ?></option> 
